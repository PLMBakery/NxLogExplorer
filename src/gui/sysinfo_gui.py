# src/gui/sysinfo_gui.py

import tkinter as tk
from tkinter import messagebox, Toplevel
from parser.sysinfo_parser import parse_system_info

def add_system_info_button(frame, app):
    system_info_button = tk.Button(frame, text="System Information", command=lambda: show_system_info(app))
    system_info_button.grid(row=0, column=0, padx=10, pady=10)
...
def show_system_info(app):
    ...
    system_info = parse_system_info(app.file_path)
    show_results(app, system_info, "System Information")
